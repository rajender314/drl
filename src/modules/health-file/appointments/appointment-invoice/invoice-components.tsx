import { boldFont, titleGray, primaryColor, primaryRed, whiteColor, textColor, greyTextColor, regularFont, extraBoldFont, mediumFont, semiBoldFont, infoBlue } from '@app/styles';
